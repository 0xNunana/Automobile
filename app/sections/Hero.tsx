    ...
    <div className=' h-[70vh] max-sm:mx-2 mx-20 mt-28 relative'>
      <div className='flex justify-between'>
        ...
        <div className=' flex flex-col flex-grow justify-center  text-white font-serif '>
          ...
          <p className=' text-5xl text-checki-hero w-full md:text-6xl lg:text-7xl xl:w-[90%] 2xl:w-[80%] text-center xl:text-8xl 2xl:text-9xl  flex-wrap font-bold   '>
          Fast And Easy Way To Buy 
        {' '} <span className='text-[#fe5c3d]'>An Affordable </span> 
        {' '}Car </p>
          </div>
       
          <p className='text-center lg:w-[50%] xl:w-[50%]  mx-auto md:my-5 lg:my-6 xl:my-10 text-xl max-sm:text-sm  max-sm:my-3 text-checki-gray'>Discover RentalX car rental options in USA with rents a car. Select from a range of car options and local specials</p>
